...
//   const resolveSuggestedLocation = async (location: { name: string }) => {
//     try {
//       const res = await tripService.getLocationCoord({ address: location.name });
//       return res?.location;
//     } catch (err) {
...
//                             onSelect={async (suggestionLocation) => {
//                               const resolved = await resolveSuggestedLocation(suggestionLocation);
//                               if (!resolved) return;
